...
#define GLOBAL_UBO_VAR_LIST \
	...
	\
	GLOBAL_UBO_VAR_LIST_DO(float,           fog_mean_height) \
	GLOBAL_UBO_VAR_LIST_DO(float,           fog_thickness) \
	GLOBAL_UBO_VAR_LIST_DO(float,           fog_inv_thickness) \
	GLOBAL_UBO_VAR_LIST_DO(float,           fog_range) \
	\
